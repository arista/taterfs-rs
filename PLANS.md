...
- Work on a way to log operations, both to provide output for operations, and to create test cases to really 
- Work on a way to make all uses of time mockable
- Create full integration tests cases, enough to assure myself that I can start using it for real
- Be able to translate from the old tfs format
