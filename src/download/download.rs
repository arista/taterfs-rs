...
// =============================================================================
// DryRunDownloadActions
// =============================================================================

/// A [`DownloadActions`] implementation that records actions without executing them.
///
/// Used for dry-run mode where we want to see what would happen without
/// making any changes to the file store.
pub struct DryRunDownloadActions {
    actions: std::sync::Mutex<Vec<String>>,
}

impl Default for DryRunDownloadActions {
    fn default() -> Self {
        Self::new()
    }
}
...
impl DryRunDownloadActions {
    /// Create a new `DryRunDownloadActions`.
    pub fn new() -> Self {
        Self {
